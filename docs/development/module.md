Extending the behavior of a Thuya application can be done using modules. Each module has a metadata, can return content providers and controllers. A module can be created by extending the `Module` class.
